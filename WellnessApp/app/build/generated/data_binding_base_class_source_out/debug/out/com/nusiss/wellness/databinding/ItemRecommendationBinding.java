...
public final class ItemRecommendationBinding implements ViewBinding {
  ...
  private ItemRecommendationBinding(@NonNull LinearLayout rootView, @NonNull TextView tvReason,
  ...
  public static ItemRecommendationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemRecommendationBinding((LinearLayout) rootView, tvReason, tvTitle);
    }
